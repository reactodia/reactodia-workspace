...
type ProvidedProps = Omit<HaloLinkProps, keyof PaperWidgetProps> & Required<PaperWidgetProps>;
...
export class HaloLink extends React.Component<HaloLinkProps, State> {
    ...
    componentDidUpdate(prevProps: HaloLinkProps) {
    ...
    private onSourceMove = (e: React.MouseEvent<HTMLElement>) => {
        const {paperArea, onSourceMove} = this.props as ProvidedProps;
    ...
    private onTargetMove = (e: React.MouseEvent<HTMLElement>) => {
        const {paperArea, onTargetMove} = this.props as ProvidedProps;
        const point = paperArea.pageToPaperCoords(e.pageX, e.pageY);
        onTargetMove(point);
    }
    ...
    private renderEditLabelButton() {
        const {view, target, paperArea, onEditLabel} = this.props as ProvidedProps;
